...
#ifndef EXAMPLECONSTCONVECTION_H
#define EXAMPLECONSTCONVECTION_H
 ...
 */
template <>
InputParameters validParams<ExampleConstConvection>();
 ...
 */
class ExampleConstConvection : public Kernel
{
public:
  /**
   ...
   */
  ExampleConstConvection(const InputParameters & parameters);
...
#endif // EXAMPLECONSTCONVECTION_H
